    ...
    <section className="section-padding bg-white">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-600 leading-relaxed">
          ...
          the best of Henderson and Vance County, NC. From festivals to community gatherings, local businesses
          to hidden outdoor spots &mdash; we&apos;re your guide to everything that makes our home special.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-12">
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">
              Find local businesses, restaurants, parks, and attractions throughout Vance County.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 text-sm">
              Join a growing network of locals and visitors who love Henderson as much as we do.
            </p>
          </div>
        </div>
      </div>
