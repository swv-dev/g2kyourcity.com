...
export default function AppFeatures() {
  return (
    <section id="app-features" className="section-padding bg-navy text-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          <div>
            ...
            <h3 className="text-2xl md:text-3xl font-bold mb-6">
              See Henderson Like Never Before
            </h3>
          ...
          <div className="bg-white/10 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-300">Experience Henderson through augmented reality on your iPhone</p>
          </div>
        </div>
          ...
          <div className="order-1 lg:order-2">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start">
                ...
                <span><strong>Leaderboards</strong> — Compete with friends and other locals to become the ultimate Henderson explorer</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="bg-white/5 rounded-2xl p-8 md:p-12">
          ...
          <div className="text-center mt-10">
            <a href="mailto:info@g2khenderson.com" className="btn-secondary">
              Partner With Us
            </a>
          </div>
        </div>
